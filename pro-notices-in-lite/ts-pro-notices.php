...
class ts_pro_notices {
	...
	* @since 3.5
	*/
	public static $plugin_name = "Order Delivery Date for WooCommerce";
	...
	*/
	...
	public static $plugin_prefix = 'orddd_lite';
	...
	public static function ts_notices_of_pro() {
        ...
        if( !is_plugin_active( 'order-delivery-date/order_delivery_date.php' ) && 
			...
			if ( get_user_meta( get_current_user_id(), self::$pro_plugin_prefix . '_first_notice_ignore' ) &&  
				...
				$orddd_first_ignore_time = get_user_meta( get_current_user_id(), self::$pro_plugin_prefix . '_first_notice_ignore_time' );
				$orddd_fifteen_days = strtotime( '+15 Days', $orddd_first_ignore_time[0] );
			...
			if ( get_user_meta( get_current_user_id(), self::$pro_plugin_prefix . '_first_notice_ignore' ) &&
				...
				$orddd_second_ignore_time = get_user_meta( get_current_user_id(), self::$pro_plugin_prefix . '_second_notice_ignore_time' );
            ...
            if ( get_user_meta( get_current_user_id(), self::$pro_plugin_prefix . '_first_notice_ignore' ) &&
            	...
            	$orddd_third_ignore_time = get_user_meta( get_current_user_id(), self::$pro_plugin_prefix . '_third_notice_ignore_time' );
            ...
            if ( get_user_meta( get_current_user_id(), self::$pro_plugin_prefix . '_first_notice_ignore' ) &&
				...
				$orddd_fourth_ignore_time = get_user_meta( get_current_user_id(), '_fourth_notice_ignore_time' );
...
$ts_pro_notices = new ts_pro_notices();